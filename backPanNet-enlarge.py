...
train_step3 = tf.train.GradientDescentOptimizer(learning_rates).minimize(loss3)
...
plt.ylabel('Accuracy')
plt.title('Accuracy for backPanNet-enlarge')
plt.savefig('backPanNet-enlarge_acc.png', bbox_inches='tight')

saver = tf.train.Saver()
saver.save(sess, './backPanNet-enlarge')
np.savetxt('backPanNet-enlarge_test_accuracy.txt',accuracy_test_data )