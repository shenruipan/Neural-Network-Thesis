...
plt.ylabel('Accuracy')
plt.title('Accuracy for backPanNet')
plt.savefig('backPanNet_acc.png', bbox_inches='tight')

saver = tf.train.Saver()
saver.save(sess, './backPanNet')
np.savetxt('backPanNettest_accuracy.txt',accuracy_test_data )